...
exports.closeDay = exports.getNightlyChecks = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const getNightlyChecks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const todaysSales = yield prisma.sale.aggregate({
            where: {
                storeId,
                createdAt: {
                    gte: today,
        ...
        const topSellingItems = yield prisma.saleItem.groupBy({
            by: ['productId'],
            where: {
                sale: {
                    storeId,
...
exports.getNightlyChecks = getNightlyChecks;
